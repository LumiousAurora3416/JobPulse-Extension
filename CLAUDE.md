...
- **文档同步**：用户说"更新版本记录"或每次阶段性完成功能后，同步更新：
  ...
  - `PROJECT_REVIEW.md` — 附录状态快照同步（✅ 已完成 / ⏳ 下一迭代待做），项目数据递增
  - CLAUDE.md — 路线图勾选已完成项、更新表格字段说明

### PROJECT_REVIEW 写作规范

用户的复盘文档是 PM 视角的深度记录，受众是自己和面试官，要求：

1. **技术问题四段式**：现象 → 根因 → 解决方案 → 学到了什么
2. **决策对比表**：凡是产品和技术的选型（A vs B），用表格对比维度+决策
3. **状态快照同步**：附录的 ✅ 已完成 / ⏳ 下一迭代待做 必须和实际进度一致
4. **数据递增**：代码行数、commit 数、文件数每次迭代更新
5. **面试总结**：一句话说清解决了什么、怎么做的、学到了什么
